...
function Nav() {
    ...
    return (
        <header style={{ marginBottom: '80px', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
            <NavLink to="/" className="brand" style={{ fontFamily: "'Space Mono', monospace", fontWeight: 400, letterSpacing: '0px', color: 'var(--text-main)', textDecoration: 'none', textTransform: 'uppercase', fontSize: '24px' }}>
                Edward B. Zhang
            </NavLink>

            <div className="header-links" style={{ textAlign: 'right', fontFamily: "'Space Mono', monospace", fontSize: '18px', color: 'var(--text-muted)' }}>
                <div style={{ marginBottom: '12px', color: '#aaa', opacity: 0.8, fontWeight: 600, letterSpacing: '1px', fontSize: '17px', fontFamily: "'Space Mono', monospace" }}>ELSEWHERE</div>
